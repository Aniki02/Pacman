...
On ne stocke que le cout de l'arête, c-à-d sa longueur et sa couleur
...
class InfoArete
{
    ...
    */
    explicit InfoArete( const double & cout1, const unsigned int couleur = 0x0000FFFF)
                        :cout1(cout1), couleur(couleur){}
